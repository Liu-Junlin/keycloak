...
import cn.tdsj.keycloak.authentication.authenticators.resetcred.jpa.TduaSmsMessage;
...
public class ResetCredentialSms implements Authenticator, AuthenticatorFactory {
    ...
    private static final String PROVIDER_ID = "reset-credential-sms-tdua";
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        String phoneNumber = authenticationSession.getAuthNote(ResetCredentialChooseUser.ATTEMPTED_PHONENUMBER);
        ...
        JpaUtil.getEntityManager(context).persist(tduaSmsMessage);
        Response challenge = context.form().createForm("login-phone-captcha.ftl");
    ...
    public void action(AuthenticationFlowContext context) {
        ...
        if (user != null) {
            ...
            Response challenge = context.form()
                    .setError(Messages.MISSING_PHONENUMBER)
                    .createForm("login-phone-captcha.ftl");
            context.failureChallenge(AuthenticationFlowError.INVALID_CREDENTIALS, challenge);
        }
    }
